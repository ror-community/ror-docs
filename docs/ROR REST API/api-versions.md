...
Plans to sunset a previous version will be announced at least 1 year prior to the planned sunset date, via the <Anchor label="ROR community meetings" target="_blank" href="https://ror.org/events">ROR community meetings</Anchor> and other communication channels such as the <Anchor label="ROR blog" target="_blank" href="https://ror.org/blog">ROR blog</Anchor>, <Anchor label="Mastodon" target="_blank" href="https://mastodon.social/@ResearchOrgs">Mastodon</Anchor>, <Anchor label="Bluesky" target="_blank" href="https://bsky.app/profile/ror.org">Bluesky</Anchor>, <Anchor label="LinkedIn" target="_blank" href="https://www.linkedin.com/company/ror-research-organization-registry">LinkedIn</Anchor>, the <Anchor label="ROR Technical Forum" target="_blank" href="https://groups.google.com/a/ror.org/g/ror-tech">ROR Technical Forum</Anchor>, and the <Anchor label="ROR Community Forum" target="_blank" href="https://groups.google.com/a/ror.org/g/ror-community">ROR Community Forum</Anchor>. Regular reminders will continue prior to the sunset date.
