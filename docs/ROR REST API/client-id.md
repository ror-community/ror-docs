...
<Callout icon="❗️" theme="error">
  ...
  Join the [ROR Technical Forum](https://groups.google.com/a/ror.org/g/ror-tech/) to make sure you receive notifications about the timeline for implementation of client IDs on the ROR API. We'll provide plenty of lead time to allow you to make any necessary changes to your code. Write [support@ror.org](mailto:support@ror.org) with any questions.
</Callout>
