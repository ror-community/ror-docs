...
<Callout icon="ℹ️" theme="info">
  ...
  To learn more about the Citation File Format, consult the <Anchor label="CFF README" target="_blank" href="https://github.com/citation-file-format/citation-file-format/blob/main/README.md">CFF README</Anchor> and the [Guide to the CFF schema](https://github.com/citation-file-format/citation-file-format/blob/main/schema-guide.md) .
</Callout>
