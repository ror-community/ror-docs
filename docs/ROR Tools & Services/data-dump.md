...
---
The entire ROR registry dataset is freely available on Zenodo at <https://zenodo.org/doi/10.5281/zenodo.6347574> in both JSON and CSV formats for both v1 and v2 of the ROR metadata schema. All ROR IDs and metadata in the data dump are provided under the [Creative Commons CC0 1.0 Universal Public Domain Dedication](https://creativecommons.org/publicdomain/zero/1.0//).
