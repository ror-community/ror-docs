...
The `ror_display` name can be in any language. If you prefer to select a name in a particular language, select the value for the `label` with the appropriate language code in the `lang` element.
