...
* As part of the <Anchor label="FREYA Project" target="_blank" href="https://www.project-freya.eu/">FREYA Project</Anchor> , EMBL-EBI built a tool to match text strings and PMIDs to ROR IDs called the <Anchor label="ROR predictor" target="_blank" href="https://gitlab.ebi.ac.uk/literature-services/public-projects/ROR-proto-EMBL">ROR predictor</Anchor> .
